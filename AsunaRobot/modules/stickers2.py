...
async def handler(event):
    ...
    if len(text) < 1:
        return await msg.reply("You might want to try `/2mmf text`")
...
async def drawText(image_path, text):
    ...
    if os.name == "nt":
        ...
        fnt = "./AsunaRobot/resources/RufingPersonalUse-AL5Dp.otf"
...
__help__ = """
 ...
 • `/2mmf` : memefiy any sticker and image.

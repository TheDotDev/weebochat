...
async def handler(event):
    ...
    if len(text) < 1:
        return await msg.reply("You might want to try `/1mmf text`")
...
async def drawText(image_path, text):
    ...
    if os.name == "nt":
        ...
        fnt = "./AsunaRobot/resources/Niagaraphobia-Bro3.ttf"
...
__help__ = """
 ...
 • `/1mmf` : memefiy any sticker and image.
